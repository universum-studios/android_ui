 ...
 * to its {@link Orientation#HORIZONTAL HORIZONTAL} orientation, can be pulled at its left or right
...
public class ViewPagerWidget extends ViewPager implements Widget, Pullable {
	 ...
	 */
	private final class Decorator extends PullableDecorator<ViewPagerWidget> {
