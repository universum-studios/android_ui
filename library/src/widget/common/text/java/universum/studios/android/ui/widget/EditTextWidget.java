...
public class EditTextWidget extends EditText implements Widget, FontWidget, ErrorWidget {
	...
	/**
	 * Creates a new instance of EditTextWidget within the given <var>context</var>.
	 *
	...
	public EditTextWidget(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
	...
	private final class Decorator extends EditTextDecorator<EditTextWidget> {
		...
		void superSetSelected(boolean selected) {
			EditTextWidget.super.setSelected(selected);
		}
