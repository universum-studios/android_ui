 ...
 *
 * @param <W> A type of the refreshable widget that will use this decorator.
 * @author Martin Albedinsky
 */
abstract class RefreshableDecorator<W extends ViewGroup & Pullable & Refreshable> extends PullableDecorator<W> implements Refreshable {
	 ...
	 */
	RefreshController<W> mRefreshController;
	 ...
	 * @see PullableDecorator#PullableDecorator(ViewGroup, int[])
	 */
