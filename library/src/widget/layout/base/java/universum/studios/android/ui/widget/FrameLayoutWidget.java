...
/**
 * Extended version of {@link android.widget.FrameLayout}. This updated FrameLayout supports tinting
...
public class FrameLayoutWidget extends FrameLayout implements WidgetGroup {
	 ...
	 */
	private final class Decorator extends WidgetGroupDecorator<FrameLayoutWidget> {
		...
		void superSetBackgroundDrawable(Drawable drawable) {
			FrameLayoutWidget.super.setBackgroundDrawable(drawable);
		}
		...
		void superSetBackgroundTintList(ColorStateList tint) {
			FrameLayoutWidget.super.setBackgroundTintList(tint);
		}
		...
		ColorStateList superGetBackgroundTintList() {
			return FrameLayoutWidget.super.getBackgroundTintList();
		}
		...
		void superSetBackgroundTintMode(PorterDuff.Mode tintMode) {
			FrameLayoutWidget.super.setBackgroundTintMode(tintMode);
		}
