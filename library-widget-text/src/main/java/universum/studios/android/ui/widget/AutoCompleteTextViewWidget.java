...
public class AutoCompleteTextViewWidget extends AutoCompleteTextView implements Widget, FontWidget, ErrorWidget {
	 ...
	 * without attributes.
	 */
	public AutoCompleteTextViewWidget(Context context) {
		this(context, null);
	}
	 ...
	 */
	public AutoCompleteTextViewWidget(Context context, AttributeSet attrs) {
	 ...
	 */
	public AutoCompleteTextViewWidget(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		this.init(context, attrs, defStyleAttr, 0);
	}

	/**
	 * Creates a new instance of AutoCompleteTextViewWidget within the given <var>context</var>.
	 *
	...
	public AutoCompleteTextViewWidget(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
	...
	private final class Decorator extends EditTextDecorator<AutoCompleteTextViewWidget> {
		...
		void onProcessTintValues(Context context, TypedArray tintArray, int tintColor) {
			...
			if (!UiConfig.MATERIALIZED) {
				...
				if (tintArray.hasValue(R.styleable.Ui_EditText_uiColorPopupBackground)) {
					tintInfo.popupBackgroundTint = tintArray.getColor(R.styleable.Ui_EditText_uiColorPopupBackground, 0);
				}
			}
		}
		...
		void superSetSelected(boolean selected) {
			AutoCompleteTextViewWidget.super.setSelected(selected);
		}
