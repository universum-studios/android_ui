...
public final class PullableGridFragment extends AppsGridFragment {

	@SuppressWarnings("unused")
	private static final String TAG = "PullableGridFragment";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		view.addView(inflater.inflate(R.layout.grid_view_pullable, container, false));
		return view;
	}
}
