 ...
 */
@ActionBarOptions(title = R.string.components_navigation_lists)
public final class RecyclersFragment extends BaseCollectionsFragment {

	@SuppressWarnings("unused")
	private static final String TAG = "RecyclersFragment";
