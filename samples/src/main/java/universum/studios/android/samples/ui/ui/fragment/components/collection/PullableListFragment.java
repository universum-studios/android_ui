 ...
 */
@ActionBarOptions(title = R.string.components_navigation_lists_pullable)
public final class PullableListFragment extends CapitalsListFragment {

	@SuppressWarnings("unused")
	private static final String TAG = "PullableListFragment";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		view.addView(inflater.inflate(R.layout.list_view_pullable, container, false));
		return view;
	}
}
