...
public final class SimpleGridFragment extends AppsGridFragment {

	@SuppressWarnings("unused")
	private static final String TAG = "SimpleGridFragment";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		view.addView(inflater.inflate(R.layout.grid_view_simple, container, false));
		return view;
	}
}
