...
/**
 * Extended version of {@link android.widget.AutoCompleteTextView}. This updated AutoCompleteTextView
 ...
 *      &lt;style name="Widget.AutoCompleteTextView" parent="android:Widget.Material.AutoCompleteTextView"&gt;
 *          &lt;item name="uiFontPath"&gt;roboto/roboto_light.ttf&lt;/item&gt;
 *      &lt;/style&gt;
 *      - This font will be than applied only to widgets (AutoCompleteTextViews) from this library
 *        that has this style as theirs style set through theme global attribute
 *        (like &lt;item name="android:autoCompleteTextViewStyle"&gt;@style/Widget.AutoCompleteTextView&lt;/item&gt;)
 *        or set within Xml layout (like style="@style/Widget.AutoCompleteTextView").
 *
 *      --------------------------------------------------------------------------------------------
 *
 ...
 *          // ... Some views
 *
 *          &lt;universum.studios.android.ui.widget.AutoCompleteTextViewWidget
 ...
 * See {@link AutoCompleteTextView}
 *
 * <h3>Default style attribute</h3>
 * {@link android.R.attr#autoCompleteTextViewStyle android:autoCompleteTextViewStyle}
 *
...
public class AutoCompleteTextViewWidget extends AutoCompleteTextView implements Widget, FontWidget, ErrorWidget {
	...
	/**
	 * Same as {@link #AutoCompleteTextViewWidget(android.content.Context, android.util.AttributeSet)}
	 * without attributes.
	 */
	public AutoCompleteTextViewWidget(@NonNull Context context) {
		this(context, null);
	}

	/**
	 * Same as {@link #AutoCompleteTextViewWidget(android.content.Context, android.util.AttributeSet, int)}
	 * with {@link android.R.attr#autoCompleteTextViewStyle} as attribute for default style.
	 */
	public AutoCompleteTextViewWidget(@NonNull Context context, @Nullable AttributeSet attrs) {
		this(context, attrs, android.R.attr.autoCompleteTextViewStyle);
	}

	/**
	 * Same as {@link #AutoCompleteTextViewWidget(android.content.Context, android.util.AttributeSet, int, int)}
	 * with {@code 0} as default style.
	 */
	public AutoCompleteTextViewWidget(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		this.init(context, attrs, defStyleAttr, 0);
	}

	/**
	 * Creates a new instance of AutoCompleteTextViewWidget for the given <var>context</var>.
	 *
	...
	public AutoCompleteTextViewWidget(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
	...
	public void onInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
		...
		event.setClassName(AutoCompleteTextViewWidget.class.getName());
	}
	...
	public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo info) {
		...
		info.setClassName(AutoCompleteTextViewWidget.class.getName());
	}
	 ...
	 */
	private static final class AutoTextTintInfo extends EditTextDecorator.CompoundTintInfo {
	 ...
	 */
	private final class Decorator extends EditTextDecorator<AutoCompleteTextViewWidget> {

		/**
		 * See {@link EditTextDecorator#EditTextDecorator(EditText)}.
		 */
		Decorator(AutoCompleteTextViewWidget widget) {
			super(widget);
		}
		...
		void onProcessTintAttributes(Context context, TypedArray tintAttributes, int tintColor) {
			...
			if (!UiConfig.MATERIALIZED) {
				final AutoTextTintInfo tintInfo = (AutoTextTintInfo) mTintInfo;
				if (tintAttributes.hasValue(R.styleable.Ui_EditText_uiColorPopupBackground)) {
					tintInfo.popupBackgroundTint = tintAttributes.getColor(R.styleable.Ui_EditText_uiColorPopupBackground, 0);
				}
			}
		}
		...
		private void applyPopupTint() {
			...
			final Drawable popupBg = getDropDownBackground();
			if (popupBg == null) {
				return;
			}
			final AutoTextTintInfo tintInfo = (AutoTextTintInfo) mTintInfo;
		...
		void superSetCompoundDrawables(Drawable left, Drawable top, Drawable right, Drawable bottom) {
			AutoCompleteTextViewWidget.super.setCompoundDrawables(left, top, right, bottom);
		}
		...
		void superSetCompoundDrawablesRelative(Drawable left, Drawable top, Drawable right, Drawable bottom) {
			AutoCompleteTextViewWidget.super.setCompoundDrawablesRelative(left, top, right, bottom);
		}
		...
		void superSetCompoundDrawableTintList(ColorStateList tint) {
			AutoCompleteTextViewWidget.super.setCompoundDrawableTintList(tint);
		}
		...
		ColorStateList superGetCompoundDrawableTintList() {
			return AutoCompleteTextViewWidget.super.getCompoundDrawableTintList();
		}
		...
		void superSetCompoundDrawableTintMode(PorterDuff.Mode tintMode) {
			AutoCompleteTextViewWidget.super.setCompoundDrawableTintMode(tintMode);
		}
		...
		PorterDuff.Mode superGetCompoundDrawableTintMode() {
			return AutoCompleteTextViewWidget.super.getCompoundDrawableTintMode();
		}
		...
		void superSetBackgroundDrawable(Drawable drawable) {
			AutoCompleteTextViewWidget.super.setBackgroundDrawable(drawable);
		}
		...
		void superSetBackgroundTintList(ColorStateList tint) {
			AutoCompleteTextViewWidget.super.setBackgroundTintList(tint);
		}
		...
		ColorStateList superGetBackgroundTintList() {
			return AutoCompleteTextViewWidget.super.getBackgroundTintList();
		}
		...
		void superSetBackgroundTintMode(PorterDuff.Mode tintMode) {
			AutoCompleteTextViewWidget.super.setBackgroundTintMode(tintMode);
		}
		...
		PorterDuff.Mode superGetBackgroundTintMode() {
			return AutoCompleteTextViewWidget.super.getBackgroundTintMode();
		}
	}
}
