...
/**
 * A {@link FontDecorator} implementation that is used to decorate {@link TextView} like widgets.
 *
 * @param <W> A type of the text widget that will use this decorator.
 * @author Martin Albedinsky
 */
abstract class TextViewDecorator<W extends TextView & FontWidget> extends FontDecorator<W> {
