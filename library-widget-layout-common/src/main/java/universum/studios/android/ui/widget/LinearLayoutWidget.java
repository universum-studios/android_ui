...
/**
 * Extended version of {@link android.widget.LinearLayout}. This updated LinearLayout supports tinting
...
public class LinearLayoutWidget extends LinearLayout implements WidgetGroup {
	...
	/**
	 * Same as {@link #LinearLayoutWidget(android.content.Context, android.util.AttributeSet)} without
	 * attributes.
	 */
	...
	/**
	 * Same as {@link #LinearLayoutWidget(android.content.Context, android.util.AttributeSet, int)}
	 * with {@code 0} as attribute for default style.
	 */
	public LinearLayoutWidget(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.init(context, attrs, 0, 0);
	}

	/**
	 * Same as {@link #LinearLayoutWidget(android.content.Context, android.util.AttributeSet, int, int)}
	...
	public LinearLayoutWidget(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
	...
	public void onInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
		...
		event.setClassName(LinearLayoutWidget.class.getName());
	}
	...
	public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo info) {
		...
		info.setClassName(LinearLayoutWidget.class.getName());
	}
	 ...
	 */
	private final class Decorator extends WidgetGroupDecorator<LinearLayoutWidget> {
		...
		void superSetBackgroundDrawable(Drawable drawable) {
			LinearLayoutWidget.super.setBackgroundDrawable(drawable);
		}
		...
		void superSetBackgroundTintList(ColorStateList tint) {
			LinearLayoutWidget.super.setBackgroundTintList(tint);
		}
		...
		ColorStateList superGetBackgroundTintList() {
			return LinearLayoutWidget.super.getBackgroundTintList();
		}
		...
		void superSetBackgroundTintMode(PorterDuff.Mode tintMode) {
			LinearLayoutWidget.super.setBackgroundTintMode(tintMode);
		}
		...
		PorterDuff.Mode superGetBackgroundTintMode() {
			return LinearLayoutWidget.super.getBackgroundTintMode();
		}
	}
}
