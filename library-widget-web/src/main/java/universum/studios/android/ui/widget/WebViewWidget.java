...
/**
 * Extended version of {@link android.webkit.WebView}. This updated WebView supports tinting for the
 * Android versions below {@link android.os.Build.VERSION_CODES#LOLLIPOP LOLLIPOP} and other useful
 * features described below including <b>swipe to refresh</b> and <b>pulling</b> feature.
 *
 * <h3>Tinting</h3>
 ...
 * See {@link WebView},
 * {@link R.styleable#Ui_WebView WebViewWidget Attributes}
 *
 * <h3>Default style attribute</h3>
 * {@link android.R.attr#webViewStyle android:webViewStyle}
 *
...
public class WebViewWidget extends WebView implements WidgetGroup, Refreshable {
	...
	public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo info) {
		...
		info.setClassName(WebViewWidget.class.getName());
	}
	 ...
	 */
	private final class Decorator extends RefreshableDecorator<WebViewWidget> {

		/**
		 * See {@link RefreshableDecorator#RefreshableDecorator(ViewGroup, int[])}.
		 */
		Decorator(WebViewWidget widgetGroup) {
			super(widgetGroup, R.styleable.Ui_WebView);
		}
		...
		void superSetBackgroundDrawable(Drawable drawable) {
			WebViewWidget.super.setBackgroundDrawable(drawable);
		}
		...
		void superSetBackgroundTintList(ColorStateList tint) {
			WebViewWidget.super.setBackgroundTintList(tint);
		}
		...
		ColorStateList superGetBackgroundTintList() {
			return WebViewWidget.super.getBackgroundTintList();
		}
		...
		void superSetBackgroundTintMode(PorterDuff.Mode tintMode) {
			WebViewWidget.super.setBackgroundTintMode(tintMode);
		}
		...
		PorterDuff.Mode superGetBackgroundTintMode() {
			return WebViewWidget.super.getBackgroundTintMode();
		}
	}
}
