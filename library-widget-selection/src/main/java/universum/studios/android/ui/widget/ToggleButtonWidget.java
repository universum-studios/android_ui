...
public class ToggleButtonWidget extends ToggleButton implements Widget, FontWidget {
	 ...
	 * attributes.
	 */
	public ToggleButtonWidget(@NonNull Context context) {
		this(context, null);
	}
	 ...
	 */
	public ToggleButtonWidget(@NonNull Context context, @Nullable AttributeSet attrs) {
	 ...
	 */
	public ToggleButtonWidget(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		this.init(context, attrs, defStyleAttr, 0);
	}

	/**
	 * Creates a new instance of ToggleButtonWidget for the given <var>context</var>.
	 *
	...
	public ToggleButtonWidget(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
