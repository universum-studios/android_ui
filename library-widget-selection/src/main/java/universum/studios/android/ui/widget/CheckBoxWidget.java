...
/**
 * Extended version of {@link android.widget.CheckBox} compound button. This updated CheckBox
 ...
 *      &lt;style name="Widget.CompoundButton.CheckBox" parent="android:Widget.Material.CompoundButton.CheckBox"&gt;
 *          &lt;item name="uiFontPath"&gt;roboto/roboto_light.ttf&lt;/item&gt;
 *      &lt;/style&gt;
 *      - This font will be than applied only to widgets (CheckBoxes) from this library that has this
 *        style as theirs style set through theme global attribute
 *        (like &lt;item name="android:checkBoxStyle"&gt;@style/Widget.CompoundButton.CheckBox&lt;/item&gt;)
 *        or set within Xml layout (like style="@style/Widget.CompoundButton.CheckBox").
 *
 *      --------------------------------------------------------------------------------------------
 *
 ...
 *          // ... Some views
 *
 *          &lt;universum.studios.android.ui.widget.CheckBoxWidget
 ...
 * See {@link CheckBox},
 * {@link R.styleable#Ui_CompoundButton CompoundButtonWidget Attributes}
 *
 * <h3>Default style attribute</h3>
 * {@link android.R.attr#checkboxStyle android:checkboxStyle}
 *
...
public class CheckBoxWidget extends CheckBox implements Widget, FontWidget {
	...
	/**
	 * Same as {@link #CheckBoxWidget(android.content.Context, android.util.AttributeSet)} without
	 * attributes.
	 */
	public CheckBoxWidget(@NonNull Context context) {
		this(context, null);
	}

	/**
	 * Same as {@link #CheckBoxWidget(android.content.Context, android.util.AttributeSet, int)} with
	 * {@link android.R.attr#checkboxStyle} as attribute for default style.
	 */
	public CheckBoxWidget(@NonNull Context context, @Nullable AttributeSet attrs) {
		this(context, attrs, android.R.attr.checkboxStyle);
	}

	/**
	 * Same as {@link #CheckBoxWidget(android.content.Context, android.util.AttributeSet, int, int)}
	 * with {@code 0} as default style.
	 */
	public CheckBoxWidget(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		this.init(context, attrs, defStyleAttr, 0);
	}

	/**
	 * Creates a new instance of CheckBoxWidget for the given <var>context</var>.
	 *
	...
	public CheckBoxWidget(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
	...
	public void onInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
		...
		event.setClassName(CheckBoxWidget.class.getName());
	}
	...
	public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo info) {
		...
		info.setClassName(CheckBoxWidget.class.getName());
	}
	 ...
	 */
	private final class Decorator extends CompoundButtonDecorator<CheckBoxWidget> {

		/**
		 * See {@link CompoundButtonDecorator#CompoundButtonDecorator(CompoundButton)}.
		 */
		Decorator(CheckBoxWidget widget) {
			super(widget);
		}
		...
		void superSetButtonDrawable(Drawable button) {
			CheckBoxWidget.super.setButtonDrawable(button);
		}
		...
		void superSetButtonTintList(ColorStateList tint) {
			CheckBoxWidget.super.setButtonTintList(tint);
		}
		...
		ColorStateList superGetButtonTintList() {
			return CheckBoxWidget.super.getButtonTintList();
		}
		...
		void superSetButtonTintMode(PorterDuff.Mode tintMode) {
			CheckBoxWidget.super.setButtonTintMode(tintMode);
		}
		...
		PorterDuff.Mode superGetButtonTintMode() {
			return CheckBoxWidget.super.getButtonTintMode();
		}
		...
		void superSetBackgroundDrawable(Drawable drawable) {
			CheckBoxWidget.super.setBackgroundDrawable(drawable);
		}
		...
		void superSetBackgroundTintList(ColorStateList tint) {
			CheckBoxWidget.super.setBackgroundTintList(tint);
		}
		...
		ColorStateList superGetBackgroundTintList() {
			return CheckBoxWidget.super.getBackgroundTintList();
		}
		...
		void superSetBackgroundTintMode(PorterDuff.Mode tintMode) {
			CheckBoxWidget.super.setBackgroundTintMode(tintMode);
		}
		...
		PorterDuff.Mode superGetBackgroundTintMode() {
			return CheckBoxWidget.super.getBackgroundTintMode();
		}
	}
}
